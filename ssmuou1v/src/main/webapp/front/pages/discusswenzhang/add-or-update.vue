	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusswenzhang`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discusswenzhang`, this.ruleForm);
				}else{
					await this.$api.add(`discusswenzhang`, this.ruleForm);
				}
