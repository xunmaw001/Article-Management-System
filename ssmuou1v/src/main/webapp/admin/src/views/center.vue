  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zuozhe'"  label="作者账号" prop="zuozhezhanghao">
          <el-input v-model="ruleForm.zuozhezhanghao" readonly              placeholder="作者账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='zuozhe'"  label="作者姓名" prop="zuozhexingming">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zuozhe'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zuozhe'"  label="身份证" prop="shenfenzheng">
          <el-input v-model="ruleForm.shenfenzheng"               placeholder="身份证" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='zuozhe'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.shenfenzheng)&& 'zuozhe'==this.flag){
        this.$message.error('身份证不能为空');
        return
      }
      if( 'zuozhe' ==this.flag && this.ruleForm.shenfenzheng&&(!checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
