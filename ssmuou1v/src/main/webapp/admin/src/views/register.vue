  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">文章管理系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='zuozhe'" class="input-group">
			   <div class="label">作者账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zuozhezhanghao" class="input" type="text" placeholder="作者账号">
			   </div>
			 </div> -->
			<el-form-item label="作者账号" class="input" v-if="tableName=='zuozhe'">
			...
			<!-- <div v-if="tableName=='zuozhe'" class="input-group">
			   <div class="label">作者姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zuozhexingming" class="input" type="text" placeholder="作者姓名">
			   </div>
			 </div> -->
			...
			<el-form-item label="手机" class="input" v-if="tableName=='zuozhe'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='zuozhe'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='zuozhe'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			</el-form-item>
