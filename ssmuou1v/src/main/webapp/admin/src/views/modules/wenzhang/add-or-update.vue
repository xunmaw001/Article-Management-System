<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文章名称" prop="wenzhangmingcheng">
          <el-input v-model="ruleForm.wenzhangmingcheng" 
              placeholder="文章名称" clearable  :readonly="ro.wenzhangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文章名称" prop="wenzhangmingcheng">
              <el-input v-model="ruleForm.wenzhangmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作者账号" prop="zuozhezhanghao">
          <el-input v-model="ruleForm.zuozhezhanghao" 
              placeholder="作者账号" clearable  :readonly="ro.zuozhezhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作者账号" prop="zuozhezhanghao">
              <el-input v-model="ruleForm.zuozhezhanghao" 
                placeholder="作者账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zuozhezhanghao!=''&&json.zuozhezhanghao){
              		this.ruleForm.zuozhezhanghao = json.zuozhezhanghao
		}
		if(json.zuozhexingming!=''&&json.zuozhexingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/wenzhangfenlei/leibie`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.wenzhangneirong = this.ruleForm.wenzhangneirong.replace(reg,'../../../ssmuou1v/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
